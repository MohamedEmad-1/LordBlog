...
description: How to use Git Hooks to set your Created and Modified Dates on Evelx Logs Of A Random Dev
---
...
As this project uses npm, we are able to make use of a package called [Husky](https://typicode.github.io/husky/) (this is already installed in Evelx Logs Of A Random Dev) to automatically install the hooks for us.

> Update! In Evelx Logs Of A Random Dev [v4.3.0](https://github.com/MohamedEmad-1/releases/tag/v4.3.0), the pre-commit hook has been removed in favor of GitHub Actions. However, you can easily [install Husky](https://typicode.github.io/husky/get-started.html) yourself.

## The Hook

As we want this hook to run as we commit the code to update the dates and then have that as part of our change we are going to use the `pre-commit` hook. This has already been set up by this Evelx Logs Of A Random Dev project, but if it hadn't, you would run `npx husky add .husky/pre-commit 'echo "This is our new pre-commit hook"'`.
...
If your IDE supports snippets then there is the option to create a custom snippet to populate the frontmatter.[In Evelx Logs Of A Random Dev v4 will come with one for VSCode by default.](https://github.com/MohamedEmad-1/pull/206)

<video autoplay muted="muted" controls plays-inline="true" class="border border-skin-line">
  <source src="https://github.com/MohamedEmad-1/assets/17761689/e13babbc-2d78-405d-8758-ca31915e41b0" type="video/mp4">
</video>
